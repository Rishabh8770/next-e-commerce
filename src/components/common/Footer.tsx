          ...
          <div className="flex flex-wrap -mx-3 items-center">
            ...
            <div className="w-full md:w-1/3 px-3 text-right">
              <div className="social-media">
                Get Connected:
                <a href="#" className="mx-2 text-white"><i className="fa fa-facebook"></i></a>
                <a href="#" className="mx-2 text-white"><i className="fa fa-twitter"></i></a>
                <a href="#" className="mx-2 text-white"><i className="fa fa-instagram"></i></a>
                <a href="#" className="mx-2 text-white"><i className="fa fa-youtube"></i></a>
              </div>
            </div>
          </div>
        </div>
